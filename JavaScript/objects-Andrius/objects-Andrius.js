...
function showMostPowerfulManufacturer(carOne, carTwo) {
  ...
  // alert(`${mostPowerfulCar.manufacturer} car is better (${mostPowerfulCar.enginePowerHP})`);
  alert(
    `${mostPowerfulCar.manufacturer} car is better than ${lessPowerfullCar.manufacturer}.`
  );
}
